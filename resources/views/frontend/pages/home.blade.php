    ...
    <article class="content">
                ...
                <div class="row">
                    <div class="carousel no-responsive gallery">
                        <div class="col-sm-4 col-md-3">
                            <a class="gallery-images" rel="fancybox" href="{{ URL::asset('public/img/front/content/office-1.jpg')}}">
                                <img src="{{ URL::asset('public/img/front/content/office-1-270.jpg')}}" width="270" height="135" alt="">
                                <span class="bg-images"><i class="fa fa-search"></i></span>
                            </a>
                        </div>
                        <div class="col-sm-4 col-md-3">
                            <a class="gallery-images" rel="fancybox" href="{{ URL::asset('public/img/front/content/office-2.jpg')}}">
                                <img src="{{ URL::asset('public/img/front/content/office-2-270.jpg')}}" width="270" height="135" alt="">
                                <span class="bg-images"><i class="fa fa-search"></i></span>
                            </a>
                        </div>
                        <div class="col-sm-4 col-md-3">
                            <a class="gallery-images" rel="fancybox" href="{{ URL::asset('public/img/front/content/office-3.jpg')}}">
                                <img src="{{ URL::asset('public/img/front/content/office-3-270.jpg')}}" width="270" height="135" alt="">
                                <span class="bg-images"><i class="fa fa-search"></i></span>
                            </a>
                        </div>
                        <div class="col-sm-4 col-md-3">
                            <a class="gallery-images" rel="fancybox" href="{{ URL::asset('public/img/front/content/office-4.jpg')}}">
                                <img src="{{ URL::asset('public/img/front/content/office-4-270.jpg')}}" width="270" height="135" alt="">
                                <span class="bg-images"><i class="fa fa-search"></i></span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row filter-elements">
                        <div class="work-element web-design col-xs-12 col-sm-3 col-md-3">
                            <a href="portfolio-single.html" class="work">
                                <img src="{{ URL::asset('public/img/front/content/portfolio-1-270.jpg')}}" width="270" height="197" alt="">
                        ...
                        <div class="work-element graphic-design col-xs-12 col-sm-3 col-md-3">
                            <a href="portfolio-single.html" class="work">
                                <img src="{{ URL::asset('public/img/front/content/portfolio-2-270.jpg')}}" width="270" height="197" alt="">
                                <span class="shadow"></span>
                                <div class="bg-hover"></div>
                                <div class="work-title">
                        ...
                        <div class="work-element ecommerce col-xs-12 col-sm-3 col-md-3">
                            <a href="portfolio-single.html" class="work">
                                <img src="{{ URL::asset('public/img/front/content/portfolio-3-270.jpg')}}" width="270" height="197" alt="">
                                <span class="shadow"></span>
                                <div class="bg-hover"></div>
                                <div class="work-title">
                        ...
                        <div class="work-element graphic-design col-xs-12 col-sm-3 col-md-3">
                            <a href="portfolio-single.html" class="work">
                                <img src="{{ URL::asset('public/img/front/content/portfolio-4-270.jpg')}}" width="270" height="197" alt="">
                                <span class="shadow"></span>
                                <div class="bg-hover"></div>
                                <div class="work-title">
                        ...
                        <div class="work-element graphic-design col-xs-12 col-sm-3 col-md-3">
                            <a href="portfolio-single.html" class="work">
                                <img src="{{ URL::asset('public/img/front/content/portfolio-5-270.jpg')}}" width="270" height="197" alt="">
                                <span class="shadow"></span>
                                <div class="bg-hover"></div>
                                <div class="work-title">
                        ...
                        <div class="work-element ecommerce col-xs-12 col-sm-3 col-md-3">
                            <a href="portfolio-single.html" class="work">
                                <img src="{{ URL::asset('public/img/front/content/portfolio-6-270.jpg')}}" width="270" height="197" alt="">
                                <span class="shadow"></span>
                                <div class="bg-hover"></div>
                                <div class="work-title">
                        ...
                        <div class="work-element ecommerce col-xs-12 col-sm-3 col-md-3">
                            <a href="portfolio-single.html" class="work">
                                <img src="{{ URL::asset('public/img/front/content/portfolio-7-270.jpg')}}" width="270" height="197" alt="">
                                <span class="shadow"></span>
                                <div class="bg-hover"></div>
                                <div class="work-title">
                        ...
                        <div class="work-element web-design col-xs-12 col-sm-3 col-md-3">
                            <a href="portfolio-single.html" class="work">
                                <img src="{{ URL::asset('public/img/front/content/portfolio-8-270.jpg')}}" width="270" height="197" alt="">
                                <span class="shadow"></span>
                                <div class="bg-hover"></div>
                                <div class="work-title">
                    ...
                    <div class="panel-group multi-collapse" id="accordion2">
                        <div class="panel panel-default active">
                            ...
                            <div id="collapse21" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <img src="{{ URL::asset('public/img/front/content/animations-100.png')}}" class="alignright" width="100" height="62" alt="">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse23" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <img src="{{ URL::asset('public/img/front/content/animations-100.png')}}" class="alignleft" width="100" height="62" alt="">
                        ...
                        <div class="col-sm-3 col-md-3 product rotation">
                            <div class="default">
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-11.jpg')}}" alt="" title="" width="270" height="270">
                                </a>
                            ...
                            <div class="product-hover">
                                ...
                                <div class="price">$1, 449.00</div>
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-11.jpg')}}" alt="" title="" width="70" height="70">
                                </a>
                                <ul>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                        ...
                        <div class="col-sm-3 col-md-3 product rotation">
                            <div class="default">
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-12.jpg')}}" alt="" title="" width="270" height="270">
                                </a>
                                <div class="product-description">
                                    <div class="vertical">
                                        <h3 class="product-name">
                            ...
                            <div class="product-hover">
                                ...
                                <div class="price">$1, 449.00</div>
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-12.jpg')}}" alt="" title="" width="70" height="70">
                                </a>
                                <ul>
                                    <li>117 cm / 46"LCD TV</li>
                                    <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                        ...
                        <div class="col-sm-3 col-md-3 product rotation">
                            <div class="default">
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-13.jpg')}}" alt="" title="" width="270" height="270">
                                </a>
                                <div class="product-description">
                                    <div class="vertical">
                                        <h3 class="product-name">
                            ...
                            <div class="product-hover">
                                ...
                                <div class="price">$1, 449.00</div>
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-13.jpg')}}" alt="" title="" width="70" height="70">
                                </a>
                                <ul>
                                    <li>117 cm / 46"LCD TV</li>
                                    <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                        ...
                        <div class="col-sm-3 col-md-3 product rotation">
                            <div class="default">
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-14.jpg')}}" alt="" title="" width="270" height="270">
                                </a>
                                <div class="product-description">
                                    <div class="vertical">
                                        <h3 class="product-name">
                            ...
                            <div class="product-hover">
                                ...
                                <div class="price">$1, 449.00</div>
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-14.jpg')}}" alt="" title="" width="70" height="70">
                                </a>
                                <ul>
                                    <li>117 cm / 46"LCD TV</li>
                                    <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                        ...
                        <div class="col-sm-3 col-md-3 product rotation">
                            <div class="default">
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-5.jpg')}}" alt="" title="" width="270" height="270">
                                </a>
                                <div class="product-description">
                                    <div class="vertical">
                                        <h3 class="product-name">
                            ...
                            <div class="product-hover">
                                ...
                                <div class="price">$1, 449.00</div>
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-5.jpg')}}" alt="" title="" width="70" height="70">
                                </a>
                                <ul>
                                    <li>117 cm / 46"LCD TV</li>
                                    <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                        ...
                        <div class="col-sm-3 col-md-3 product rotation">
                            <div class="default">
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-6.jpg')}}" alt="" title="" width="270" height="270">
                                </a>
                                <div class="product-description">
                                    <div class="vertical">
                                        <h3 class="product-name">
                            ...
                            <div class="product-hover">
                                ...
                                <div class="price">$1, 449.00</div>
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-6.jpg')}}" alt="" title="" width="70" height="70">
                                </a>
                                <ul>
                                    <li>117 cm / 46"LCD TV</li>
                                    <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                        ...
                        <div class="col-sm-3 col-md-3 product rotation">
                            <div class="default">
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-7.jpg')}}" alt="" title="" width="270" height="270">
                                </a>
                                <div class="product-description">
                                    <div class="vertical">
                                        <h3 class="product-name">
                            ...
                            <div class="product-hover">
                                ...
                                <div class="price">$1, 449.00</div>
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-7.jpg')}}" alt="" title="" width="70" height="70">
                                </a>
                                <ul>
                                    <li>117 cm / 46"LCD TV</li>
                                    <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                        ...
                        <div class="col-sm-3 col-md-3 product rotation">
                            <div class="default">
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-8.jpg')}}" alt="" title="" width="270" height="270">
                                </a>
                                <div class="product-description">
                                    <div class="vertical">
                                        <h3 class="product-name">
                            ...
                            <div class="product-hover">
                                ...
                                <div class="price">$1, 449.00</div>
                                <a href="shop-product-view.html" class="product-image">
                                    <img src="{{ URL::asset('public/img/front/content/product-8.jpg')}}" alt="" title="" width="70" height="70">
                                </a>
                                <ul>
                                    <li>117 cm / 46"LCD TV</li>
                                    <li>Full HD 3D &amp; 2D</li>
        ...
        <div class="full-width-box bottom-padding cm-padding-bottom-36">
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-sm-3 col-md-3 rotation employee">
                        <div class="default">
                            <div class="image">
                                <img src="{{ URL::asset('public/img/front/content/team-1.jpg')}}" alt="" title="" width="270" height="270">
                            </div>
		  ...
		  --><div class="col-sm-3 col-md-3 rotation employee">
                        <div class="default">
                            <div class="image">
                                <img src="{{ URL::asset('public/img/front/content/team-2.jpg')}}" alt="" title="" width="270" height="270">
                            </div>
                            <div class="description">
                                <div class="vertical">
		  ...
		  --><div class="col-sm-3 col-md-3 rotation employee">
                        <div class="default">
                            <div class="image">
                                <img src="{{ URL::asset('public/img/front/content/team-3.jpg')}}" alt="" title="" width="270" height="270">
                            </div>
                            <div class="description">
                                <div class="vertical">
		  ...
		  --><div class="col-sm-3 col-md-3 rotation employee">
                        <div class="default">
                            <div class="image">
                                <img src="{{ URL::asset('public/img/front/content/team-4.jpg')}}" alt="" title="" width="270" height="270">
                            </div>
                            <div class="description">
                                <div class="vertical">
                ...
                <div class="col-sm-12 col-md-6 promo-partners bottom-padding">
                    ...
                    <div class="row manufactures manufactures-list">
                        <div class="make-wrapper">
                            <a href="#" class="make">
                                <img src="{{ URL::asset('public/img/front/content/make-2.png')}}" width="128" height="128" alt="">
                            </a>
                        </div><!--

			--><div class="make-wrapper">
                            <a href="#" class="make">
                                <img src="{{ URL::asset('public/img/front/content/make-3.png')}}" width="128" height="128" alt="">
                            </a>
                        </div><!--

			--><div class="make-wrapper">
                            <a href="#" class="make">
                                <img src="{{ URL::asset('public/img/front/content/make-4.png')}}" width="128" height="128" alt="">
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <ul class="latest-posts">
                        <li>
                            <img class="image img-circle" src="{{ URL::asset('public/img/front/content/product-1-84.jpg')}}" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
                            <div class="meta">
                        ...
                        <li>
                            <img class="image img-circle" src="{{ URL::asset('public/img/front/content/product-2-84.jpg')}}" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
                            <div class="meta">
                                <span>Mike Example</span>,
                                <span class="time">03.11.2013, 10:45:</span>
                            </div>
                        ...
                        <li>
                            <img class="image img-circle" src="{{ URL::asset('public/img/front/content/product-3-84.jpg')}}" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
                            <div class="meta">
                                <span>Mike Example</span>,
                                <span class="time">03.11.2013, 10:45:</span>
                            </div>
